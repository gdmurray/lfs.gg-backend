...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='approved_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='league_approved_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='leaguerequest',
            name='league',
